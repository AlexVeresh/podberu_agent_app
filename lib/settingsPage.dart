...
import 'package:podberu_app/settingsPageData.dart';
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Выйти из аккаунта",
                  style: TextStyle(color: Color.fromRGBO(249, 75, 98, 1), fontSize: 15, fontWeight: FontWeight.w600, letterSpacing: -0.24),
                ),
              )
            ],
          ),
